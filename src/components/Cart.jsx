                        ...
                        <tbody>
                            {cart.map((product, index) => (
                                <tr key={index} className="border-bottom">
                                    ...
                                    {/* Se muestra solo en md y pantallas más grandes */}
                                    <td className="py-5">
                                        <Button onClick={() => decreaseQuantity(product.id)} className='bg-danger mx-2'>-</Button>
                                        {product.quantity}
                                        <Button onClick={() => increaseQuantity(product.id)} className='bg-secondary mx-2'>+</Button>
                                    </td>
                                    <td className="py-5">${(product.price).toLocaleString('es-CL')}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
