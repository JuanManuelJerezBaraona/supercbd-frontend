            ...
            <section className="container-fluid bg-primary text-white">
                <div className="row w-75 mx-auto py-5">
                    ...
                    <div className='col-12 d-flex flex-column align-items-center mt-5'>
                        ...
                        <a href="https://www.linkedin.com/in/juan-manuel-jerez-baraona-b54486274/" target="_blank" className='col-12 col-md-6 col-lg-3 btn py-2 rounded-pill btn-secondary text-primary fw-bold shadow-lg mt-4'><i className="bi bi-linkedin fs-5"></i> Linkedin</a>
                    </div>
                </div>
            </section>
        </>
